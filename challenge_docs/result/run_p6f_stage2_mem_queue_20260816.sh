...
while tmux has-session -t minicpm_opt_queue_p2 2>/dev/null; do
  sleep 30
done
...
run_perf /workspace/user_data/vllm-omni \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p6f_a1_default_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p6f_a1_default_simplex_20260816_120000.log
run_perf /workspace/user_data/vllm-omni-worktrees/p6f-stage2-mem \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p6f_b_stage2_mem_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p6f_b_stage2_mem_simplex_20260816_120000.log
run_perf /workspace/user_data/vllm-omni \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p6f_a2_default_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p6f_a2_default_simplex_20260816_120000.log

cd /workspace/user_data/vllm-omni-worktrees/p6f-stage2-mem
export PYTHONPATH="/workspace/user_data/vllm-omni-worktrees/p6f-stage2-mem:${PYTHONPATH:-}"
env ASCEND_RT_VISIBLE_DEVICES=0 \
  ...
  ACC_BENCH_RESULT_DIR=/workspace/user_data/vllm-omni/challenge_docs/batch_result/p6f_stage2_mem_accuracy \
  ...
  tee /workspace/user_data/vllm-omni/challenge_docs/run_log/p6f_stage2_mem_seed_accuracy_20260816_120000.log
