...
while tmux has-session -t minicpm_opt_queue_p6f 2>/dev/null; do
  sleep 30
done
...
run_perf /workspace/user_data/vllm-omni \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p6g_a1_default_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p6g_a1_default_simplex_20260816_120000.log
run_perf /workspace/user_data/vllm-omni-worktrees/p6g-prefix-cache \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p6g_b_prefix_cache_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p6g_b_prefix_cache_simplex_20260816_120000.log
run_perf /workspace/user_data/vllm-omni \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p6g_a2_default_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p6g_a2_default_simplex_20260816_120000.log

cd /workspace/user_data/vllm-omni-worktrees/p6g-prefix-cache
export PYTHONPATH="/workspace/user_data/vllm-omni-worktrees/p6g-prefix-cache:${PYTHONPATH:-}"
env ASCEND_RT_VISIBLE_DEVICES=0 \
  ...
  ACC_BENCH_RESULT_DIR=/workspace/user_data/vllm-omni/challenge_docs/batch_result/p6g_prefix_cache_accuracy \
  ...
  tee /workspace/user_data/vllm-omni/challenge_docs/run_log/p6g_prefix_cache_seed_accuracy_20260816_120000.log
