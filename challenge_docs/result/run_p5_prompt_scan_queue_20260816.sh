...
while tmux has-session -t minicpm_opt_queue_p4 2>/dev/null; do
  sleep 30
done
...
run_perf /workspace/user_data/vllm-omni \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p5_a1_default_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p5_a1_default_simplex_20260816_120000.log
run_perf /workspace/user_data/vllm-omni-worktrees/p5-prompt-scan \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p5_b_prompt_scan_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p5_b_prompt_scan_simplex_20260816_120000.log
run_perf /workspace/user_data/vllm-omni \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p5_a2_default_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p5_a2_default_simplex_20260816_120000.log

cd /workspace/user_data/vllm-omni-worktrees/p5-prompt-scan
export PYTHONPATH="/workspace/user_data/vllm-omni-worktrees/p5-prompt-scan:${PYTHONPATH:-}"
env ASCEND_RT_VISIBLE_DEVICES=0 \
  ...
  ACC_BENCH_RESULT_DIR=/workspace/user_data/vllm-omni/challenge_docs/batch_result/p5_prompt_scan_accuracy \
  ...
  tee /workspace/user_data/vllm-omni/challenge_docs/run_log/p5_prompt_scan_seed_accuracy_20260816_120000.log
