...
while tmux has-session -t minicpm_opt_queue_p5 2>/dev/null; do
  sleep 30
done
...
run_perf /workspace/user_data/vllm-omni \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p2_a1_default_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p2_a1_default_simplex_20260816_120000.log
run_perf /workspace/user_data/vllm-omni-worktrees/p2-stage2-graph \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p2_b_stage2_graph_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p2_b_stage2_graph_simplex_20260816_120000.log
run_perf /workspace/user_data/vllm-omni \
  /workspace/user_data/vllm-omni/challenge_docs/batch_result/p2_a2_default_simplex \
  /workspace/user_data/vllm-omni/challenge_docs/run_log/p2_a2_default_simplex_20260816_120000.log

cd /workspace/user_data/vllm-omni-worktrees/p2-stage2-graph
export PYTHONPATH="/workspace/user_data/vllm-omni-worktrees/p2-stage2-graph:${PYTHONPATH:-}"
env ASCEND_RT_VISIBLE_DEVICES=0 \
  ...
  ACC_BENCH_RESULT_DIR=/workspace/user_data/vllm-omni/challenge_docs/batch_result/p2_stage2_graph_accuracy \
  ...
  tee /workspace/user_data/vllm-omni/challenge_docs/run_log/p2_stage2_graph_seed_accuracy_20260816_120000.log
